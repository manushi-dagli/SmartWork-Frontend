...
/** Create team member (employee) form — required: firstName, lastName; optional login (username + password) and role. */
...
export type CreateTeamMemberFormValues = z.infer<typeof createTeamMemberFormSchema>;
